...
class bahia():
    def __init__(self,p0):
        ...
        self.p0=p0
        self.salida={ "x":0, "y":230, "Descripcion":{"Nombre": "Hacia SE_XXXX", "Codigo de Linea": "L-XXXX", "Tramo linea (km)":"xx km"}, "block_name":"SALIDA_LINEA"}
        self.pr={ "x":0, "y":200, "Descripcion":{"Tension nominal (kV)": v_n, "BIL (kVp)": bil, "I nominal (A)": i_n, "Clase": 0,}, "block_name":"Pararrayos c-cd1"}
        self.tt={ "x":0, "y":160, "Descripcion":{"Tension nominal (kV)": v_n, "BIL (kVp)": bil, "Clase de Proteccion": 0, "Tipo": 0},"block_name": "TTC_AT_2S"}
        self.secc1={ "x":0, "y": 120, "Descripcion":{"Tension nominal (kV)": v_n, "BIL (kVp)": bil, "I nominal (A)": i_n, "Tipo": 0}, "block_name":"SL_AT_AV"}
        self.tc={ "x":0, "y": 85, "Descripcion":{"Tension nominal (kV)": v_n, "BIL (kVp)": bil, "I nominal (A)": i_n, "Tipo": 0, "Relacion devanado primario": 0, "Relacion devanado secundario": 0, "Burden": 0}, "block_name":"CT_AT_4S_DOWN"}
        self.ip={ "x":0, "y": 50, "Descripcion":{"Tension nominal (kV)": v_n, "BIL (kVp)": bil, "I nominal (A)": i_n}, "block_name":"IP_AT"}
        self.secc2={ "x":0, "y": 20, "Descripcion":{"Tension nominal (kV)": v_n, "BIL (kVp)": bil, "I nominal (A)": i_n, "Tipo": 0}, "block_name":"SB_AT_AC"}

...
class bahia():
    def __init__(self,p0,bil,v_Um,i_n):
        ...
        self.v_Um=v_Um
        self.i_n=i_n
        self.salida={ "x":0, "y":230, "Descripcion":{"Nombre": "Hacia SE_XXXX", "Codigo de Linea": "L-XXXX", "Tramo linea (km)":"xx km"}, "block_name":""}
        self.pr={ "x":0, "y":200, "Descripcion":{"Tension nominal (kV)": self.v_Um, "BIL (kVp)": self.bil, "I nominal (A)": self.i_n, "Clase": 0,}, "block_name":""}
        self.tt={ "x":0, "y":160, "Descripcion":{"Tension nominal (kV)": self.v_Um, "BIL (kVp)": self.bil, "Clase de Proteccion": 0, "Tipo": 0},"block_name": ""}
        self.secc1={ "x":0, "y": 120, "Descripcion":{"Tension nominal (kV)": self.v_Um, "BIL (kVp)": self.bil, "I nominal (A)": self.i_n, "Tipo": 0}, "block_name":""}
